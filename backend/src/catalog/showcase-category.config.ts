...
export const SHOWCASE_CATEGORY_DEFINITIONS: ShowcaseCategoryDefinition[] = [
  ...
  },
  {
    ...
    fallbackIncludeNames: [
      ...
      'Комбинированное соединение: сварное-резьбовое',
      'Сварное соединение',
      'Краны шаровые стальные',
      'Сливы-переливы',
      'Инсталляции для систем монтажа унитазов',
      'Трубы для наружной (безнапорной) канализации',
      'Кольца уплотнительные сантехнические',
      'Пасты и смазки для труб',
    ],
  },
  {
  ...
  },
  {
    ...
    fallbackIncludeNames: [
      ...
      'Чиллер',
      'Клапаны и петли маслоподъемные для мультизональных систем кондиционирования',
    ],
  },
  {
  ...
  },
  {
    ...
    includeNames: [
      ...
      'Осевые вентиляторы',
      'Вентиляторы крышные общеобменные',
    ...
    fallbackIncludeNames: [
      ...
      'Фасонные элементы',
      'Фильтры воздушные для систем вентиляции',
      'Решетки и диффузоры',
  ...
  },
  {
    ...
    fallbackIncludeNames: [
      ...
      'Шкафы управления Общеобменной вентиляции',
    ],
  },
  {
