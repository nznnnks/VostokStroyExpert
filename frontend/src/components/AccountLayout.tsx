    ...
    <main className="bg-white text-[#111] [font-family:DM_Sans,Manrope,'Liberation_Sans',sans-serif]">
      ...
      <section className="min-h-[calc(100svh-92px)]">
        <div className="grid xl:grid-cols-[420px_1fr]">
          <aside className="hidden border-b border-[#ece8e1] bg-[#fcfbf8] px-4 py-8 md:px-8 xl:sticky xl:top-[calc(var(--site-header-offset,76px)+6px)] xl:block xl:max-h-[calc(100vh-var(--site-header-offset,76px)-14px)] xl:overflow-y-auto xl:self-start xl:border-b-0 xl:border-r xl:py-16">
