      ...
      <div className="mx-auto max-w-[1480px] 2xl:max-w-[1860px]">
        ...
        <div className="mt-8 space-y-5 md:hidden">
          {reviews.slice(0, mobileReviewsVisible).map((review, index) => {
            ...
            const revealStateClassName = isRevealActive
