          ...
          <div className="flex items-center px-6 py-14 md:px-12 xl:px-18 xl:py-20">
            <div className="mx-auto w-full max-w-[560px]">
              ...
              <form className="mt-20 space-y-14" onSubmit={handleSubmit}>
                ...
                <label className="block">
                  <span className="text-[16px] uppercase tracking-[2px] text-[#7d7d78] [font-family:Jaldi,'JetBrains_Mono',monospace]">Пароль</span>
                  <input
                    type="password"
                    value={password}
                ...
                <button
                  disabled={loading}
                  className="inline-flex h-20 w-full items-center justify-center gap-8 bg-[#111] px-10 text-[20px] uppercase tracking-[3px] text-white [font-family:Jaldi,'JetBrains_Mono',monospace]"
                >
