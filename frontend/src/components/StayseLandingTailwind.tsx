...
const steps = [
  ...
  ["/image/steps-2.png", "Моделирование", "Проектируем инженерную схему, считаем нагрузки и согласовываем логику системы."],
  ["/image/steps-3.png", "Интеграция", "Встраиваем оборудование в архитектуру, интерьер и существующие инженерные сети."],
  ["/image/steps-4.png", "Производим автоматизацию системы", "Производим пуско-наладку всего оборудования и распределительных устройств воздуха. Передаём в эксплуатацию систему , с полным перечнем исполнительных документов."],
];
        ...
        <div className="relative z-10 left-1/2 w-screen -translate-x-1/2">
          <div className="px-3 sm:px-5 md:px-10 xl:px-12 2xl:px-20">
            ...
            <div className="flex min-h-[118px] flex-col justify-start rounded-[18px] bg-white px-6 py-5 text-[#12120f] md:min-h-[124px] md:px-8 md:py-5 xl:min-h-[132px] xl:justify-between xl:px-10 xl:py-6">
              ...
              <h2 className="mt-7 max-w-[12ch] text-[clamp(32px,8vw,46px)] leading-[0.92] tracking-[-0.03em] [font-family:'Cormorant_Garamond',serif] md:mt-0 md:max-w-[14ch] md:text-[clamp(28px,2vw,40px)] md:leading-[0.98] md:tracking-[-0.02em]">Climatrade</h2>
            </div>
